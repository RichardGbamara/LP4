...
# Impact of earth quake on sales 
final = pd.read_csv('C:\\Users\\user\\Desktop\\DESKTOP FOLDERS\\ASSIGNMENTS\\Streamlit\\src\\train6.csv')
# earthquake_ = pd.to_datetime ('2016-04-16')
# #Get sales mean before earthquake 
# sales_before_earthquake = final[final['date'] < earthquake_] ['sales'].mean()
# #Get sales mean after earthquake 
# sales_after_earthquake = final[final['date'] > earthquake_] ['sales'].mean()

# # Plot average mean before and after earthquake 
# st.write( "# Effect of sales before and after earthquake ")
