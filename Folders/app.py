...
# Custom make the pagelayout to be black 
st.markdown(
    """
    <style>
    body {
...
pickle_in = open("C:/Users/user/Desktop/DESKTOP FOLDERS/ASSIGNMENTS/LP4 - STREAMLIT -- TEAM PARIS/src/model22.pkl","rb")
model22 = pickle.load(pickle_in)
